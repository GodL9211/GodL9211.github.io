import{_ as p}from"./haige_wechat_public-ccb5a382.js";import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as c,o as i,c as l,a as n,b as s,e,f as t}from"./app-bc047c8d.js";const u={},r=n("h2",{id:"为什么要使用多线程",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#为什么要使用多线程","aria-hidden":"true"},"#"),s(" 为什么要使用多线程？")],-1),d={href:"https://www.zhihu.com/question/23474039",target:"_blank",rel:"noopener noreferrer"},k=t(`<p>python3中多线程的实现使用了threading模块，它允许同一进程中运行多个线程。</p><h3 id="如何创建和执行一个线程" tabindex="-1"><a class="header-anchor" href="#如何创建和执行一个线程" aria-hidden="true">#</a> 如何创建和执行一个线程</h3><p>一般我们有两种方法来创建线程，一种是以某个函数来作为起点，另一种是继承Thread类。</p><h4 id="方法一" tabindex="-1"><a class="header-anchor" href="#方法一" aria-hidden="true">#</a> 方法一</h4><p>获取一个Thread对象，构造参数中target是起点函数，<code>注意不要加括号</code>。假如起点函数有参数，则可以通过args输入元组参数或者kwargs输入字典参数。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">#! -*-conding=: UTF-8 -*-</span>
